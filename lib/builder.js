...
// Generate JS code
Builder.prototype.genJS = function(input, output, isWorker) {
    var that = this;
    if (!input || !output) {
        return Q(false);
    }
    ...
    var require_config = this.genRJSConfig(input, output, isWorker);
...
Builder.prototype.genAllJS = function() {
    ...
    .reduce(function(prev, file) {
        return prev.then(function() {
            return that.genJS(file.input, file.output, file.isWorker);
        });
    }, Q())
    .value()
};
...
Builder.prototype.genRJSConfig = function(input, output, isWorker) {
    ...
    return _.extend({
        ...
        paths: _.extend(config.paths || {}, {
            ...
            "jQuery":           path.resolve(vendors_path, isWorker? "jquery.nodom": "jquery"),
